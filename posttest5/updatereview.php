...
// Query untuk mengambil data review berdasarkan ID
...
<body>
    <div class="container mx-auto relative">
        ...
        <main>
            ...
            <form action="process_update.php?id=<?php echo $row['id']; ?>" method="POST" class="review-form mx-auto col-6 d-flex-col">
