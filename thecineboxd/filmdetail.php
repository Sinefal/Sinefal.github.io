        ...
        <main class="row film-detail-section relative">
            <?php if ($film): ?>
                ...
                <div class="col-9 sm-col-8 film-detail-info text-white">
                    ...
                    <p class="sinopsis film-description"><?= nl2br(htmlspecialchars($film['synopsis'], ENT_QUOTES, 'UTF-8')); ?></p>
                ...
                <?php while ($review = $reviews->fetch_assoc()): ?>
                    <div class="review-item col-12 d-flex-row align-items-start">
                        <div class="review-text col-10">
                            ...
                            <p class="sinopsis"><?= nl2br(htmlspecialchars($review['review'], ENT_QUOTES, 'UTF-8')); ?></p>
                        </div>
                        <?php if ($is_admin || $user_id == $review['user_id']): ?>
                            <div class="review-actions">
                            <button class="icon-button" onclick="editReview(<?= $review['review_id']; ?>)">
